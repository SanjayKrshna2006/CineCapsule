...
export declare const ENGINE_VERSION = 895;
...
export default class FilterEngine extends EventEmitter<EngineEventHandlers> {
     ...
     */
    getCosmeticsFilters({ url, hostname, domain, ancestors, classes, hrefs, ids, getBaseRules, getInjectionRules, getExtendedRules, getRulesFromDOM, getRulesFromHostname, hidingStyle, callerContext, }: {
        url: string;
        hostname: string;
    ...
    matchCosmeticFilters({ url, hostname, domain, ancestors, classes, hrefs, ids, getRulesFromDOM, getRulesFromHostname, getInjectionRules, getExtendedRules, callerContext, }: {
        url: string;
        hostname: string;
        domain: string | null | undefined;
        ancestors?: {
